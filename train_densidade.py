...
from tensorflow.keras.layers import Input, Conv2D, MaxPooling2D, BatchNormalization, ReLU
...
# === Modelo inspirado em CSRNet com dilated convolutions ===
def build_density_model(input_shape=(224, 224, 3)):
    ...
    model.compile(optimizer=Adam(1e-4), loss='mae')  # <- mae é mais robusto
    return model
